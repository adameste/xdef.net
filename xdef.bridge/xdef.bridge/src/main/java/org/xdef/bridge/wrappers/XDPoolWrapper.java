...
public class XDPoolWrapper extends RemoteHandlingObject {
    ...
    private Response getVersionInfo(BinaryDataReader reader) throws IOException {
    ...
    private Response createXDDocument1(BinaryDataReader reader) throws IOException {
        // Read params here
    ...
    private Response createXDDocument2(BinaryDataReader reader) throws IOException {
        // Read params here
        // Do actions
    ...
    private Response exists(BinaryDataReader reader) throws IOException {
        // Read params here
        String arg1 = reader.readSharpString();
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response getXMDefinitions(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
    ...
    private Response getXMDefinitionNames(BinaryDataReader reader) throws IOException {
        // Read params here
        // Do actions
    ...
    private Response getXMDefinition1(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
        // Read params here
        // String arg1 = reader.readSharpString();
        // Do actions
    ...
    private Response getXMDefinition2(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
    }

    // Autogenerated method
    // public abstract org.xdef.model.XMNode findModel(java.lang.String);
    private Response findModel(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
    ...
    private Response display1(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
    }

    // Autogenerated method
    // public abstract void display();
    private Response display2(BinaryDataReader reader) throws IOException {
        // Read params here
        // Do actions
        xdPool.display();
    ...
    private Response displayCode1(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
    ...
    private Response displayCode2(BinaryDataReader reader) throws IOException {
        xdPool.displayCode();
        return new EmptyResponse();
    }
    ...
    private Response displayDebugInfo1(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
    }

    // Autogenerated method
    // public abstract void displayDebugInfo();
    private Response displayDebugInfo2(BinaryDataReader reader) throws IOException {
        // Read params here
        // Do actions
    ...
    private Response getDebugInfo(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
        /*
    ...
    private Response getVariableTable(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
        /*
    ...
    private Response getDisplayMode (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isResolveIncludes (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isDebugMode (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isDebugShowResult (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isIgnoreUnresolvedExternals (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isLocationsdetails (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isIllegalDoctype (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response isChkWarnings (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    // getXComponents();
    private Response getXComponents (BinaryDataReader reader) throws IOException, OperationNotSupportedException
    {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
    ...
    // public abstract java.util.Map<java.lang.String, java.lang.String>
    // getXComponentBinds();
    private Response getXComponentBinds (BinaryDataReader reader) throws IOException, OperationNotSupportedException
    {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
    ...
    // public abstract java.util.Map<java.lang.String, java.lang.String>
    // getXComponentEnums();
    private Response getXComponentEnums (BinaryDataReader reader) throws IOException, OperationNotSupportedException
    {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
    ...
    private Response getSpecialDates (BinaryDataReader reader) throws IOException, OperationNotSupportedException
    {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
    ...
    private Response getXDSourceInfo(BinaryDataReader reader) throws IOException, OperationNotSupportedException {
        throw new OperationNotSupportedException();
        // Read params here
        // Do actions
    ...
    private Response getDebugEditor (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response getXdefEditor (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
