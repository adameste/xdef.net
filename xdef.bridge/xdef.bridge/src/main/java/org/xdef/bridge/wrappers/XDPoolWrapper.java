...
public class XDPoolWrapper extends RemoteHandlingObject {
    ...
    public Response getXMDefinitions (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        XMDefinition[]Wrapper wrap = new XMDefinition[]Wrapper(client, xdPool.getXMDefinitions());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getXMDefinitionNames (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        String[]Wrapper wrap = new String[]Wrapper(client, xdPool.getXMDefinitionNames());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getXMDefinition1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        String arg1 = reader.readSharpString();
        // Do actions
        XMDefinitionWrapper wrap = new XMDefinitionWrapper(client, xdPool.getXMDefinition(arg1));
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getXMDefinition2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        XMDefinitionWrapper wrap = new XMDefinitionWrapper(client, xdPool.getXMDefinition());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response findModel (BinaryDataReader reader) throws IOException
    {
        // Read params here
        String arg1 = reader.readSharpString();
        // Do actions
        XMNodeWrapper wrap = new XMNodeWrapper(client, xdPool.findModel(arg1));
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response display1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        PrintStream arg1 = reader.readPrintStream();
        // Do actions
        voidWrapper wrap = new voidWrapper(client, xdPool.display(arg1));
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response display2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        voidWrapper wrap = new voidWrapper(client, xdPool.display());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response displayCode1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        PrintStream arg1 = reader.readPrintStream();
        // Do actions
        voidWrapper wrap = new voidWrapper(client, xdPool.displayCode(arg1));
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response displayCode2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        voidWrapper wrap = new voidWrapper(client, xdPool.displayCode());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response displayDebugInfo1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        PrintStream arg1 = reader.readPrintStream();
        // Do actions
        voidWrapper wrap = new voidWrapper(client, xdPool.displayDebugInfo(arg1));
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response displayDebugInfo2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        voidWrapper wrap = new voidWrapper(client, xdPool.displayDebugInfo());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getDebugInfo (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        XMDebugInfoWrapper wrap = new XMDebugInfoWrapper(client, xdPool.getDebugInfo());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getVariableTable (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        XMVariableTableWrapper wrap = new XMVariableTableWrapper(client, xdPool.getVariableTable());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getDisplayMode (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        byteWrapper wrap = new byteWrapper(client, xdPool.getDisplayMode());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isResolveIncludes (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isResolveIncludes());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isDebugMode (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isDebugMode());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isDebugShowResult (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isDebugShowResult());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isIgnoreUnresolvedExternals (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isIgnoreUnresolvedExternals());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isLocationsdetails (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isLocationsdetails());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isIllegalDoctype (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isIllegalDoctype());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response isChkWarnings (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        booleanWrapper wrap = new booleanWrapper(client, xdPool.isChkWarnings());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getXComponents (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    public Response getXComponentBinds (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    public Response getXComponentEnums (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    public Response getMinYear (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        intWrapper wrap = new intWrapper(client, xdPool.getMinYear());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getMaxYear (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        intWrapper wrap = new intWrapper(client, xdPool.getMaxYear());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getXDSourceInfo (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    public Response getDebugEditor (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        StringWrapper wrap = new StringWrapper(client, xdPool.getDebugEditor());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
    ...
    public Response getXdefEditor (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        StringWrapper wrap = new StringWrapper(client, xdPool.getXdefEditor());
        BinaryDataBuilder builder = new BinaryDataBuilder();
        builder.add(client.registerRemoteObject(wrap));
        return new Response(builder.build());
    }
