...
public class XDFactoryWrapper extends RemoteHandlingObject {
    ...
    private Response getXDVersion (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
    ...
    private Response getXDBuilder1 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response compileXD1 (BinaryDataReader reader) throws IOException
    {
        Properties props = readProperties(reader);
    ...
    private Response compileXD2 (BinaryDataReader reader) throws IOException
    {
        Properties props = readProperties(reader);
        int cnt = reader.readInt();
        URL[] arr = new URL[cnt];
    ...
    private Response compileXD3 (BinaryDataReader reader) throws IOException
    {
        Properties props = readProperties(reader);
        int cnt = reader.readInt();
    ...
    private Response compileXD4 (BinaryDataReader reader) throws IOException
    {
        Properties props = readProperties(reader);
        int cnt = reader.readInt();
    ...
    private Response compileXD5 (BinaryDataReader reader) throws IOException
    {
        Properties props = readProperties(reader);
    ...
    private Response compileXD6 (BinaryDataReader reader) throws IOException
    {
        Properties props = readProperties(reader);
        Object[] sources = readObjectArgs(reader);
    ...
    private Response createXDInput1 (BinaryDataReader reader) throws IOException
    {
        InputStream inputStream = new RemoteInputStream(new RemoteStreamWrapper(client, reader.readInt()));
    ...
    private Response createXDInput2 (BinaryDataReader reader) throws IOException
    {
        // Not yet implemented
    ...
    private Response createXDInput3 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response createXDOutput1 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response createXDOutput2 (BinaryDataReader reader) throws IOException
    {
        // Not implemented yet
        throw new UnsupportedOperationException();
    }
    ...
    private Response createXDOutput3 (BinaryDataReader reader) throws IOException
    {
        // Not yet implemented
        throw new UnsupportedOperationException();
    }
    ...
    private Response createXDElement (BinaryDataReader reader) throws IOException
    {
    ...
    private Response createXDNamedValue (BinaryDataReader reader) throws IOException
    {
    ...
    private Response createXDContainer1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createXDContainer2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createSQLService1 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response createSQLService2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createXDResultSet1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createXDResultSet2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createXDXmlOutStream1 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createXDXmlOutStream2 (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createParseResult (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response createXDValue (BinaryDataReader reader) throws IOException
    {
        // Read params here
        // Do actions
        BinaryDataBuilder builder = new BinaryDataBuilder();
    ...
    private Response writeXDPool1 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response writeXDPool2 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response writeXDPool3 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response readXDPool1 (BinaryDataReader reader) throws IOException
    {
        InputStream inputStream = new RemoteInputStream(new RemoteStreamWrapper(client, reader.readInt()));
    ...
    private Response readXDPool2 (BinaryDataReader reader) throws IOException
    {
        File f = new File(reader.readSharpString());
    ...
    private Response readXDPool3 (BinaryDataReader reader) throws IOException
    {
    ...
    private Response readXDPool4 (BinaryDataReader reader) throws IOException
    {
