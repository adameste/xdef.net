...
namespace xdef.net.Sys
{
    public sealed class Report : RemoteObject
    {
        ...
        public String GenModification()
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                var res = SendRequestWithResponse(new Request(FUNCTION_GENMODIFICATION, builder.Build(), ObjectId));
        ...
        public long GetTimestamp()
        {
            using (var builder = new BigEndianDataBuilder())
            {
                ...
                {
                    // Read response here
                    return new long(reader.ReadInt32(), _client);
                }
            }
        }
        ...
        public Element ToXmlElement(Document arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
        ...
        public Object SetLanguage(String arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_SETLANGUAGE, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
        ...
        public Report Audit(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_AUDIT_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
                }
            }
        }
        ...
        public Report Fatal(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
        ...
        public Report Error(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
        ...
        public Report LightError(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_LIGHTERROR_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report Warning(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
        ...
        public Report Message(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_MESSAGE_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report Info(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_INFO_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report String(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_STRING_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report Text(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_TEXT_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public String GetRawReportText(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETRAWREPORTTEXT_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String GetReportText(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETREPORTTEXT_1, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String GetReportText(String arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETREPORTTEXT_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String GetLocalizedText(String arg0, String arg1, String arg2, String arg3)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                ...
                builder.Add(arg2);
                builder.Add(arg3);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETLOCALIZEDTEXT_3, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String[] GetReportParamNames(String arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETREPORTPARAMNAMES, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
        ...
        public String GetLocalizedText(long arg0, String arg1, String arg2)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                ...
                builder.Add(arg1);
                builder.Add(arg2);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETLOCALIZEDTEXT_4, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public Report Audit(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_AUDIT_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report LightError(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_LIGHTERROR_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report Warning(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
        ...
        public Report Message(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_MESSAGE_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report Info(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_INFO_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report String(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_STRING_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report Text(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_TEXT_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public String GetReportID(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETREPORTID, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String GetRawReportText(long arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETRAWREPORTTEXT_2, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String GetReportText(long arg0, String arg1)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                builder.Add(arg1);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETREPORTTEXT_3, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public String GetReportText(long arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_GETREPORTTEXT_4, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    return reader.ReadString();
                }
        ...
        public Report BuildInfo()
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                var res = SendRequestWithResponse(new Request(FUNCTION_BUILDINFO, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
        ...
        public Report ReadObj(SObjectReader arg0)
        {
            using (var builder = new BigEndianDataBuilder())
            {
                // Serialize args here
                builder.Add(arg0);
                var res = SendRequestWithResponse(new Request(FUNCTION_READOBJ, builder.Build(), ObjectId));
                using (var reader = res.Reader)
                {
                    // Read response here
                    return new Report(reader.ReadInt32(), _client);
